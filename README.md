...
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-gnannsumpw/tags). For example,

```javascript
import gnannsumpw from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gnannsumpw@v0.1.0-esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gnannsumpw.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gnannsumpw

[test-image]: https://github.com/stdlib-js/blas-ext-base-gnannsumpw/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-gnannsumpw/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gnannsumpw/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gnannsumpw?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gnannsumpw.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gnannsumpw/main
...
[branches-url]: https://github.com/stdlib-js/blas-ext-base-gnannsumpw/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-gnannsumpw/main/LICENSE
...
[@stdlib/blas/ext/base/snannsumpw]: https://github.com/stdlib-js/blas-ext-base-snannsumpw/tree/esm
