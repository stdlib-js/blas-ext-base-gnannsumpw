...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gnannsumpw/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gnannsumpw/actions/workflows/test.yml?query=branch:v0.1.1
