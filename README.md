...
```javascript
import gnannsumpw from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gnannsumpw@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gnannsumpw@v0.1.0-deno/mod.js';
```
...
[@stdlib/blas/ext/base/snannsumpw]: https://github.com/stdlib-js/blas-ext-base-snannsumpw/tree/deno
